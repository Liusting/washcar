				...
				<block v-for="addressKey,i in addressKeys" :key="i" >
					<block v-if="listKey==addressKey">
						<view class="a-item" 
							...
							<image v-if="selectedAddress[addressKey]!=null&&item.city_id==selectedAddress[addressKey].city_id" class="selected-icon" src="/static/image/selected_address.png"></image>
						</view>
					</block>
